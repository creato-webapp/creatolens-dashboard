  ...
  return (
    <FeatureLayout
      ...
      card={{
        ...
        description:
          'Trend Analysis lets you monitor and manage scraped posts from the past 3 or 7 days, tracking activity by topic after pairing Instabot with your 2TAG account.',
        buttonUrl: '#',
      }}
      session={{
