...
const FeatureLayout = (props: IFeatureLayout) => {
  return (
    <div className="feature-layout flex w-full flex-col items-center">
      <div className="flex flex-col gap-12 px-6 py-2 md:gap-32 lg:max-w-screen-xl">
        <div className="flex w-full flex-col">
          <div>
            <h1 className="px-16 py-3 text-heading text-neutral-800">{props.heading}</h1>
            <hr className="my-4 w-full border-t border-neutral-200" />
          </div>
          <div className="card flex w-full flex-col  gap-8 md:flex-row">
            <div className="relative aspect-video w-full">
              <Image src={props.card.image || '/GuildHeroHeader.png'} fill alt={props.card.heading} />
            </div>
