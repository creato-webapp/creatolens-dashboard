...
export default function Navbar(props: NavbarProps) {
  ...
  const navBarItemList: Array<navBarItem> = [
    { title: 'Home', href: '/', role: ['player'] },
    { title: 'Accounts', href: '/accounts', role: ['player'] },
    { title: 'Blocked Accounts', href: '/accounts-blocked', role: ['player'] },
    { title: 'Retry Accounts', href: '/accounts-retry', role: ['player'] },
    { title: 'Account Login Error', href: '/accounts-error', role: ['player'] },
  ]
