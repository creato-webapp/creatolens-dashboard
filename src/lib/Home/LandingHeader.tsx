    ...
    >
      <div className="flex flex-col md:ml-12 md:w-1/2">
        ...
        <div className="mt-14 flex flex-row justify-center gap-8 md:mt-9 md:justify-start md:gap-3 ">
          <Button.Primary className=" w-auto" styleClassName="!py-3 !px-6" onClick={handleClick}>
            <h4>Free Trial</h4>
            <Image src={arrow_right} alt="arrow_right" width={20} height={20} className="ml-2"></Image>
          </Button.Primary>
          <Button.Outline className=" w-auto" styleClassName="!py-3 !px-6" onClick={() => signIn('google', { callbackUrl: '/' })}>
            <h4>Sign In</h4>
          </Button.Outline>
        </div>
      </div>
